...
const TextHighLight = ({ text, hightLightDefault }: TextHighLightProps) => {
    return (
        ...
        <div className="inline-block bg-[var(--regen-green)] px-4 py-2 border-4 border-black shadow-[4px_4px_0_0_#000] -rotate-2 mb-8">
          <h2 className="font-black italic text-xl uppercase tracking-widest text-black">
            {text}
          </h2>
        </div>
        ) : (
        <div className="bg-black p-4 inline-block -rotate-1 shadow-[8px_8px_0_0_var(--regen-green)]">
