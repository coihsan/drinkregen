  ...
  return (
    <Accordion 
      ...
      <AccordionItem value="tentang-promo" >
        <AccordionTrigger className="text-brand-green-700 text-lg font-bold">Tentang Promo</AccordionTrigger>
      ...
      <AccordionItem value="cara-ikut-promo">
        <AccordionTrigger className="text-brand-green-700 text-lg font-bold">Bagaimana cara bisa mengikuti promo ini?</AccordionTrigger>
        <AccordionContent className="h-full">
            ...
            <ol className="list-decimal pl-6">
                ...
                <li>Pindai (scan) QR Code pada kemasan untuk masuk ke microsite yang terdapat pada situs ini <a className="hover:underline transition-all" href={'https://regen.satu.app/'} target="_blank" aria-label="regen-satu-app">regen.satu.app</a>.</li>
      ...
      <AccordionItem value="ketentuan-peserta">
        <AccordionTrigger className="text-brand-green-700 text-lg font-bold">Siapa saja yang boleh mengikuti program ini?</AccordionTrigger>
        <AccordionContent className="h-full">
            <ul className="list-disc pl-6">
      ...
      <AccordionItem value="syarat-ketentuan">
        <AccordionTrigger className="text-brand-green-700 text-lg font-bold">Syarat dan Ketentuan Lainnya</AccordionTrigger>
        <AccordionContent className="h-full">
