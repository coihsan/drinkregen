...
export const PRODUCT300ML_VARIANTS = [
  create300mlVariant({
    ...
    textColor: "text-[var(--regen-gold)]",
    textColorDark: "text-[var(--regen-gold)]",
    titleColor: "text-brand-gold-700",
    vitaminColor: "bg-brand-gold-500",
    bgColor: "var(--regen-orange)",
    bgGradient: "from-[var(--regen-gold)] via-[var(--regen-gold-dark)] to-[var(--regen-gold-dark)]",
    accentColor: "var(--regen-yellow)",
    liquidColor: "rgba(255, 140, 0, 0.75)",
    labelColor: "var(--regen-gold)",
    nutrition: {
      calories: "0 Kalori",
      sugar: "0g",
      vitaminC: "1000mg",
  ...
  create300mlVariant({
    ...
    textColor: "text-[var(--regen-coral)]",
    textColorDark: "text-[var(--regen-red-dark)]",
    titleColor: "text-brand-coral-700",
    vitaminColor: "bg-brand-coral-500",
    bgColor: "var(--regen-coral)",
    bgGradient: "from-[var(--regen-coral-soft)] via-[var(--regen-coral-soft)] to-[var(--regen-coral)]",
    accentColor: "var(--regen-coral)",
    liquidColor: "rgba(255, 240, 245, 0.85)",
    labelColor: "var(--regen-red)",
    nutrition: {
      calories: "0 Kalori",
      sugar: "0g",
  ...
  create300mlVariant({
    ...
    textColor: "text-[var(--regen-gold)]",
    textColorDark: "text-[var(--regen-gold-dark)]",
    titleColor: "text-brand-gold-700",
    vitaminColor: "bg-brand-gold-300",
    bgColor: "var(--regen-gold)",
    bgGradient: "from-[var(--regen-gold-soft)] via-[var(--regen-gold-soft)] to-[var(--regen-gold-soft)]",
    accentColor: "var(--regen-gold)",
  ...
  create300mlVariant({
    ...
    textColor: "text-[var(--regen-forest)]",
    textColorDark: "text-[var(--regen-forest)]",
    titleColor: "text-brand-green-700",
    vitaminColor: "bg-brand-green-500",
    bgColor: "var(--regen-green)",
    bgGradient: "from-[var(--regen-forest)] via-[var(--regen-forest)] to-[var(--regen-forest)]",
    accentColor: "var(--regen-forest)",
    liquidColor: "rgba(225, 29, 72, 0.8)",
    labelColor: "var(--regen-forest)",
    nutrition: {
      calories: "0 Kalori",
      sugar: "0g",
      vitamin: ["B2", "B3", "B5", "B6", "B12"],
  ...
  create300mlVariant({
    ...
    textColor: "text-[var(--regen-red)]",
    textColorDark: "text-[var(--regen-red-dark)]",
    titleColor: "text-brand-coral-700",
    vitaminColor: "bg-brand-coral-500",
    bgColor: "var(--regen-coral)",
    bgGradient: "from-[#000000] via-[var(--regen-red)] to-[var(--regen-red)]",
    accentColor: "var(--regen-red)",
    liquidColor: "rgba(255, 175, 180, 0.75)",
    labelColor: "var(--regen-coral)",
    nutrition: {
      calories: "0 Kalori",
      sugar: "0g",
      vitamin: ["B2", "B3", "B5", "B6", "B12"],
  ...
  create300mlVariant({
    ...
    textColor: "text-[var(--regen-lime)]",
    textColorDark: "text-[var(--regen-muted)]",
    titleColor: "text-brand-lime-800",
    vitaminColor: "bg-brand-lime-500",
    bgColor: "var(--regen-lime)",
    bgGradient: "from-[var(--regen-citrus)] via-[var(--regen-lime)] to-[var(--regen-olive)]",
    accentColor: "var(--regen-lime)",
    liquidColor: "rgba(217, 249, 157, 0.7)",
    labelColor: "var(--regen-lime)",
    nutrition: {
      calories: "0 Kalori",
      sugar: "0g",
      vitamin: ["B2", "B3", "B5", "B6", "B12"],
